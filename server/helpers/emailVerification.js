                  ...
                  .then(() => {
                    transporter.sendMail({
                      ...
                      if (err) {
                        ...
                        req.flash('success_msg', 'Confirmation email sent to '+user.email+'. Please confirm your email to finish registration process!');
                      }
                      res.redirect(redirect);
                    });
                  })
              ...
              .then((user) => {
                transporter.sendMail({
                  ...
                  if (err) {
                    ...
                    req.flash('success_msg', 'Welcome! You have successfully registered to Books4You. Wish you a great learning ahead');
                  }
                  res.redirect(redirect);
                });
              }).catch((err) => {
